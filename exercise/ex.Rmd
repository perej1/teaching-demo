...
question("Is the time series stationary?",
         ...
         answer("yes"),
         message = "The time series is not stationary. There is an upward trend, which violates Assumption 2. Also, there seems to be seasonality, which violates Assumption 2 as well.")
```
...
question("Is the time series stationary?",
         ...
         message = "The time series is stationary. There is no trend or seasonality, which suggests that the stationarity assumption might hold. It is quite hard to see in this figure alone, but also the Assumption 3 is satisfied. In order to check Assumption 3 we need more tools such as the autocorrelation function.")
```
...
question("Is the time series stationary?",
         answer("no", correct = TRUE),
         answer("yes"),
         message = "The time series is not stationary. Assumption 3 is violated since variance blows up as time increases. This phenomenon is visible on the above figure.")
```
